...
const startCaseReview = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        if (caseData.status.status !== CaseStatus.SENTTOREVIEW) {
            return next(new AppError('Can\'t start review for this case', 400));
        }
...
module.exports = startCaseReview;